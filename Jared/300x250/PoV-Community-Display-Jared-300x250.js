...
lib.ssMetadata = [
		{name:"PoV_Community_Display_Jared_300x250_atlas_P_1", frames: [[0,502,1435,42],[1202,0,600,500],[0,0,1200,300]]},
		{name:"PoV_Community_Display_Jared_300x250_atlas_NP_1", frames: [[0,0,600,500]]}
];
...
(lib.AlertStripe2x = function() {
	this.initialize(ss["PoV_Community_Display_Jared_300x250_atlas_P_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.Jaredbkgd = function() {
	this.initialize(ss["PoV_Community_Display_Jared_300x250_atlas_NP_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.Jarediso = function() {
	this.initialize(ss["PoV_Community_Display_Jared_300x250_atlas_P_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib.PoVCommunityDisplayJared300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_2.setTransform(356.2,247.1,1,1,0,0,0,446.2,208.1);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({_off:false},0).to({x:475.2,alpha:1},19,cjs.Ease.quadOut).wait(156));

	// HEAD2
	this.instance_3 = new lib.HEAD2();
	this.instance_3.setTransform(-12.7,101.2,1,1,0,0,0,77.3,29.2);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(59).to({_off:false},0).to({x:106.3,alpha:1},19,cjs.Ease.quadOut).wait(98));
	...
	// PIC-iso
	this.instance_6 = new lib.Jarediso();
	...
	// PIC-bkgd
	this.instance_9 = new lib.Jaredbkgd();
...
p.nominalBounds = new cjs.Rectangle(-474.7,120.5,782.2,130);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/PoV_Community_Display_Jared_300x250_atlas_P_1.png", id:"PoV_Community_Display_Jared_300x250_atlas_P_1"},
		{src:"images/PoV_Community_Display_Jared_300x250_atlas_NP_1.jpg", id:"PoV_Community_Display_Jared_300x250_atlas_NP_1"}
	],
	preloads: []
};
