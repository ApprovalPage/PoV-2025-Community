...
lib.ssMetadata = [
		{name:"PoV_Community_Display_Della_728x90_atlas_P_1", frames: [[0,302,1435,42],[0,0,1200,300]]},
		{name:"PoV_Community_Display_Della_728x90_atlas_NP_1", frames: [[0,0,600,500]]}
];
...
(lib.AlertStripe2x = function() {
	this.initialize(ss["PoV_Community_Display_Della_728x90_atlas_P_1"]);
	this.gotoAndStop(0);
...
(lib.Dellabkgd = function() {
	this.initialize(ss["PoV_Community_Display_Della_728x90_atlas_NP_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(240.375,8.3);
	...
	this.shape_3.setTransform(223.275,5.85);
	...
	this.shape_4.setTransform(215.975,4.575);
	...
	this.shape_5.setTransform(208.975,5.85);
	...
	this.shape_6.setTransform(199.3,7.3);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgIAuIAAhbIARAAIAABbg");
	this.shape_7.setTransform(194.05,4.575);
	...
	this.shape_8.setTransform(188.625,7.25);
	...
	this.shape_9.setTransform(181.025,7.25);
	...
	this.shape_10.setTransform(173.075,5.925);
	...
	this.shape_11.setTransform(166.2,5.85);
	...
	this.shape_12.setTransform(156.075,4.625);
	...
	this.shape_13.setTransform(148.55,5.8);
	...
	this.shape_14.setTransform(140.725,5.85);
	...
	this.shape_15.setTransform(131.275,5.85);
	...
	this.shape_18.setTransform(113.075,4.575);
	...
	this.shape_19.setTransform(106.175,5.85);
	...
	this.shape_20.setTransform(96.125,5.8);
	...
	this.shape_21.setTransform(88.3,5.85);
	...
	this.shape_22.setTransform(80.975,4.575);
	...
	this.shape_23.setTransform(74.325,5.225);
	...
	this.shape_24.setTransform(65.15,5.85);
	...
	this.shape_25.setTransform(59.2,5.8);
	...
	this.shape_26.setTransform(52.425,5.85);
	...
	this.shape_27.setTransform(42.825,5.8);
	...
	this.shape_31.setTransform(15.125,5.85);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#FFFFFF").s().p("AAQArIgQhAIgPBAIgUAAIgWhVIARAAIAQBEIABgKIAPg6IARAAIAOA5IACALIAPhEIASAAIgWBVg");
	this.shape_32.setTransform(5.8,4.875);
...
p.nominalBounds = new cjs.Rectangle(0,0,241.4,12);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1, new cjs.Rectangle(-241.4,0,241.4,12), null);
...
// stage content:
(lib.PoVCommunityDisplayDella728x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(618,64,1.29,1.29);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(165).to({scaleX:1.4963,scaleY:1.4963},2).to({scaleX:1.29,scaleY:1.29},6).wait(3));

	// CTA arrow
	this.instance_1 = new lib.CTAarrow();
	this.instance_1.setTransform(686.05,61.2,1.29,1.29);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(176));

	// HEAD1
	this.instance_2 = new lib.HEAD1();
	this.instance_2.setTransform(446.2,249.1,1,1,0,0,0,446.2,208.1);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({_off:false},0).to({x:790.2,alpha:1},19,cjs.Ease.quadOut).wait(156));

	// HEAD2
	this.instance_3 = new lib.HEAD2();
	this.instance_3.setTransform(77.3,87.2,1,1,0,0,0,77.3,29.2);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(59).to({_off:false},0).to({x:421.3,alpha:1},19,cjs.Ease.quadOut).wait(98));

	// mask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_131 = new cjs.Graphics().p("AumHCIAAuDIdNAAIAAODg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(131).to({graphics:mask_graphics_131,x:634.5,y:45}).wait(45));

	// CAMPAIGN
	this.instance_4 = new lib.CAMPAIGN();
	this.instance_4.setTransform(486,57.6,1,1,0,0,0,105,23.6);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(131).to({_off:false},0).to({x:663},16,cjs.Ease.quintOut).wait(29));
	...
	this.instance_5.setTransform(23.05,19.05,0.15,0.15,0,0,0,0.4,0.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(176));

	// HEAD-bkgd
	this.instance_6 = new lib.HEADbkgdgreensvg("synched",0);
	this.instance_6.setTransform(89.9,26.1,1,1,0,0,0,172.9,63.1);

	this.instance_7 = new lib.HEADbkgdgreensvg("synched",0);
	this.instance_7.setTransform(187.05,26.1,1,1,0,0,0,172.9,63.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_7},{t:this.instance_6}]}).wait(176));

	// ALERT
	this.instance_8 = new lib.ALERT();
	this.instance_8.setTransform(-362,79.5,1,1,0,0,0,0,-10.5);
	this.instance_8.alpha = 0.3008;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(114).to({_off:false},0).to({x:250},16,cjs.Ease.quintOut).wait(46));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_10},{t:this.instance_9}]}).wait(176));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-356.7,-4,1085.2,242);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/PoV_Community_Display_Della_728x90_atlas_P_1.png", id:"PoV_Community_Display_Della_728x90_atlas_P_1"},
		{src:"images/PoV_Community_Display_Della_728x90_atlas_NP_1.jpg", id:"PoV_Community_Display_Della_728x90_atlas_NP_1"}
	],
	preloads: []
};
